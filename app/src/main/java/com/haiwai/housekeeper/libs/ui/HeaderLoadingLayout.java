package com.haiwai.housekeeper.libs.ui;
...
//        ((AnimationDrawable) ((ImageView) findViewById(R.id.donghua_pull)).getBackground()).start();
    }
...
//        findViewById(R.id.donghua_pull).setVisibility(View.IN);
...
//        findViewById(R.id.donghua_pull).setVisibility(View.VISIBLE);
