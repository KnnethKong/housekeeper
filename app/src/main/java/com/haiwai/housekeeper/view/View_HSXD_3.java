 ...
 */
public class View_HSXD_3 extends LinearLayout {
    private TextView tvtitle;
    private EditText etother;
    private CheckBox cb1, cb2, cb3, cb4, cb5, cb6;
    private String answer = "";

    public View_HSXD_3(Context context) {
        this(context, null);
    }

    public View_HSXD_3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public View_HSXD_3(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View.inflate(context, R.layout.view_hsxd_3, this);
        initView();
    }

    private void initView() {
        tvtitle = (TextView) findViewById(R.id.view_hsxd_3_tv_title);
        etother = (EditText) findViewById(R.id.view_hsxd_3_et_other);
        cb1 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_1);
        cb2 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_2);
        cb3 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_3);
        cb4 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_4);
        cb5 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_5);
        cb6 = (CheckBox) findViewById(R.id.view_hsxd_3_cb_6);
