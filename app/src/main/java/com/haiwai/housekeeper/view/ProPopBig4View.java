...
public class ProPopBig4View extends PopupWindow {
    ...
    public ProPopBig4View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_con_big4_layout, null);
