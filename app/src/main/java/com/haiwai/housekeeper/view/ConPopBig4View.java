...
public class ConPopBig4View extends PopupWindow {
    ...
    public ConPopBig4View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big4_layout, null);
