...
public class ProPopBig5View extends PopupWindow {
    ...
    public ProPopBig5View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_con_big5_layout, null);
