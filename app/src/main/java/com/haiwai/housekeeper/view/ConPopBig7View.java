...
public class ConPopBig7View extends PopupWindow {
    ...
    public ConPopBig7View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big7_layout, null);
