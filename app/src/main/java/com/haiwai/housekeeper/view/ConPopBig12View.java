...
public class ConPopBig12View extends PopupWindow {
    ...
    public ConPopBig12View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big12_layout, null);
