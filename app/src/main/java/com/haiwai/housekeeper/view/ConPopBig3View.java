...
public class ConPopBig3View extends PopupWindow {
    ...
    public ConPopBig3View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big3_layout, null);
