 ...
 */
public class PullToZoomScrollView2 extends ScrollView{
     ...
     * @param attrs
     */
    public PullToZoomScrollView2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        mTopViewHeight=mScreenHeight/2-(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 90, context.getResources().getDisplayMetrics());
        mTopViewHeight=metrics.widthPixels*465/750;
    }
...
//            mTopView.setTranslationY(t / 2);//使得TopView滑动的速度小于滚轮滚动的速度
    ...
    public interface ScrollViewListener {
        ...
        void onScrollChanged(PullToZoomScrollView2 scrollView, int x, int y,
                             int oldx, int oldy);
