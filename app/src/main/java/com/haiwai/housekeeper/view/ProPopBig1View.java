...
public class ProPopBig1View extends PopupWindow {
    ...
    public ProPopBig1View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_con_big1_layout, null);
