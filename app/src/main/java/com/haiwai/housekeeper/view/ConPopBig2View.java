...
public class ConPopBig2View extends PopupWindow {
    ...
    public ConPopBig2View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big2_layout, null);
