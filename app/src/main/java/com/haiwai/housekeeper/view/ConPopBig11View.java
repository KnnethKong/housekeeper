...
public class ConPopBig11View extends PopupWindow {
    ...
    public ConPopBig11View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big8_layout, null);
