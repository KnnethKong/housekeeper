 ...
 */
public class View_JSJL_6 extends LinearLayout {
    private TextView tvtitle;
    private EditText etother;
    private CheckBox cb1, cb2, cb3, cb4, cb5, cb6;
    private String answer = "";

    public View_JSJL_6(Context context) {
        this(context, null);
    }

    public View_JSJL_6(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public View_JSJL_6(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData1(String title, String r1, String r2, String r3, String r4, String r5) {
        ...
        findViewById(R.id.img4).setVisibility(View.GONE);
        findViewById(R.id.img5).setVisibility(View.GONE);
    }
