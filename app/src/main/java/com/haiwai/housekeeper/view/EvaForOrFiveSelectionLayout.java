...
public class EvaForOrFiveSelectionLayout extends LinearLayout {
    ...
    public EvaForOrFiveSelectionLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        LayoutInflater.from(context).inflate(R.layout.evaluate_four_five_star_layout, this);
        setViews();
    }
