...
public class ConPopBig10View extends PopupWindow {
    ...
    public ConPopBig10View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big10_layout, null);
