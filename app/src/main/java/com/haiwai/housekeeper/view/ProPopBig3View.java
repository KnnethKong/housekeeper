...
public class ProPopBig3View extends PopupWindow {
    ...
    public ProPopBig3View(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_con_big3_layout, null);
