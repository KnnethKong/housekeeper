...
public class ConPopBigView extends PopupWindow {
    ...
    public ConPopBigView(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big_layout, null);
