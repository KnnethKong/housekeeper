...
public class ConPopBig4View_1 extends PopupWindow {
    ...
    public ConPopBig4View_1(Activity context, String content) {
    ...
    private void initView(Context context) {
        popView = mInflater.inflate(R.layout.pro_pop_big4_layout_1, null);
