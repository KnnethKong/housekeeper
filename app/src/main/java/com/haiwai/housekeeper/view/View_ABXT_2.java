...
public class View_ABXT_2 extends LinearLayout {
    ...
    public View_ABXT_2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public View_ABXT_2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        tvtitle = (TextView) findViewById(R.id.view_abxt_2_tv_title);
        radioGroup = (RadioGroup) findViewById(R.id.view_abxt_2_rg);
        etother = (EditText) findViewById(R.id.view_abxt_2_et_other);
        rb1 = (RadioButton) findViewById(R.id.view_abxt_2_rb_1);
        rb2 = (RadioButton) findViewById(R.id.view_abxt_2_rb_2);
        rb3 = (RadioButton) findViewById(R.id.view_abxt_2_rb_3);
        rb4 = (RadioButton) findViewById(R.id.view_abxt_2_rb_4);
        rb5 = (RadioButton) findViewById(R.id.view_abxt_2_rb_5);
        rb6 = (RadioButton) findViewById(R.id.view_abxt_2_rb_6);
        rb7 = (RadioButton) findViewById(R.id.view_abxt_2_rb_7);
        rb8 = (RadioButton) findViewById(R.id.view_abxt_2_rb_8);
...
//        });
    ...
    public void setData(String title, String r1, String r2, String r3, String r4, String r5, String r6, String r7, String r8) {
        tvtitle.setText(title);
        rb1.setText(r1);
        rb2.setText(r2);
        rb3.setText(r3);
...
//        });
    ...
    public void setData(String title, String r1, String r2, String r3, String r4, String r5, String r6, String r7, String r8, String answer) {
        tvtitle.setText(title);
        rb1.setText(r1);
        rb2.setText(r2);
        rb3.setText(r3);
...
//        });
    ...
    public boolean getIsEmpty() {
        if (radioGroup.getCheckedRadioButtonId() == rb8.getId()||radioGroup.getCheckedRadioButtonId() == rb7.getId()) {
    ...
    public String getAnswer() {
        if (radioGroup.getCheckedRadioButtonId() == rb1.getId()) {
            ...
            answer = "8|str" + etother.getText().toString().trim();
        }
        return answer;
    }
}
