 ...
 */
public class View_FLZX_3_1 extends LinearLayout {//禁止复用
    ...
    public View_FLZX_3_1(Context context) {
        this(context, null);
    }

    public View_FLZX_3_1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public View_FLZX_3_1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(getContext(), 28, 6);
            ...
            list.add("25公里");
            list.add("50公里");
            List<String> answerList = JsonUtils.getZhAnswerList(getContext(), 28, 6);
            rb1.setText(answerList.get(0));
            rb2.setText(answerList.get(1));
            rb3.setText(answerList.get(2));

        } else {
            String question = JsonUtils.getENQuestion(getContext(), 28, 6);
            tvtitle.setText(question);
            list.add("5miles");
            list.add("10miles");
            list.add("15miles");
            list.add("25miles");
            list.add("50miles");
            List<String> answerList = JsonUtils.getENAnswerList(getContext(), 28, 6);
            rb1.setText(answerList.get(0));
            rb2.setText(answerList.get(1));
            rb3.setText(answerList.get(2));
        }
