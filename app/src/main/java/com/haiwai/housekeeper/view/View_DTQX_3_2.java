 ...
 */
public class View_DTQX_3_2 extends LinearLayout {
    ...
    public View_DTQX_3_2(Context context) {
        this(context, null);
    }

    public View_DTQX_3_2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public View_DTQX_3_2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View.inflate(context, R.layout.view_dtqx_3_2, this);
        initView();
    }
