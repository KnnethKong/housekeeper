...
import com.haiwai.housekeeper.view.View_JSJL_11;
 ...
 */
public class IssueRequireKActivity extends BaseActivity {
    ...
    private View_DTQX_11 view_dtqx;
    private View_FWBJ_8 view_cpxj;
    private View_FWBJ_8 view_bybj;

    private View_FWBJ_9 view_fwwx;
    private View_FWBJ_9 view_yywx;
    private View_FWBJ_8 view_swfs;
    private View_JJYC_1 view_glwx;

    private View_JSJL_11 view_jsjl;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireKActivity.this, ProDetailActivity.class, bundle);
                    ...
                    if(Integer.valueOf(id)>=19){
                        ...
                        ActivityTools.goNextActivity(IssueRequireKActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireKActivity.this, O2ODetailActivity.class, bundle);
                    }
//                    Bundle bundle = new Bundle();
//                    bundle.putString("id", IMKitService.lagMap.get("id"));
//                    ActivityTools.goNextActivity(IssueRequireKActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "2":
                addView_CPXJ();
                seekBar.setProgress(100 * 11 / 13);
                tvprogress.setText(100 * 11 / 13 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 11 / 13)), 5, 0, 0);
                break;
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 11 / 16);
                tvprogress.setText(100 * 11 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 11 / 16)), 5, 0, 0);
                break;
            case "6"://搬运搬家
                addView_BYBJ();
                seekBar.setProgress(100 * 11 / 13);
            ...
            case "10"://房屋维修
                addView_FWWX();
                seekBar.setProgress(100 * 11 / 12);
                tvprogress.setText(100 * 11 / 12 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 11 / 12)), 5, 0, 0);
                break;
            case "11"://园艺维修
                addView_YYWX();
                seekBar.setProgress(100 * 11 / 12);
            ...
            case "14"://室内粉刷
                addView_SNFS();
                seekBar.setProgress(100 * 11 / 14);
                tvprogress.setText(100 * 11 / 14 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 11 / 14)), 5, 0, 0);
                break;
            case "15"://室外粉刷
                addView_SWFS();
                seekBar.setProgress(100 * 11 / 13);
...
//                break;
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 11 / 15);
                tvprogress.setText(100 * 11 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 11 / 15)), 5, 0, 0);
                break;
        }
    }

    private void addView_DTQX() {
        view_dtqx = new View_DTQX_11(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 3, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 3, 10);
            if("1".equals(make_sure)){
            ...
            String question = JsonUtils.getENQuestion(this, 3, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 3, 10);
            if("1".equals(make_sure)){
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),answer);
            }else{
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_CPXJ() {
        view_cpxj = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 2, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 2, 10);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList, answer);
            } else {
                view_cpxj.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 2, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 2, 10);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList, answer);
            } else {
                view_cpxj.setData(question, answerList);
    ...
    private void addView_BYBJ() {
        view_bybj = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 6, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 6, 10);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList, answer);
            } else {
                view_bybj.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 6, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 6, 10);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList, answer);
            } else {
                view_bybj.setData(question, answerList);
    ...
    private void addView_FWWX() {
        view_fwwx = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 10, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 10, 10);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 10, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 10, 10);
            if ("1".equals(make_sure)) {
                view_fwwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_fwwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_YYWX() {
        view_yywx = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 11, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 11, 10);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 11, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 11, 10);
            if ("1".equals(make_sure)) {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_SWFS() {
        view_swfs = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 15, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 15, 10);
            if ("1".equals(make_sure)) {
                view_swfs.setData(question, answerList, answer);
            } else {
                view_swfs.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 15, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 15, 10);
            if ("1".equals(make_sure)) {
                view_swfs.setData(question, answerList, answer);
            } else {
                view_swfs.setData(question, answerList);
...
//        view_glwx = new View_JJYC_1(this);
//        if ("zh".equalsIgnoreCase(isZhorEn)) {
//            String question = JsonUtils.getZhQuestion(this, 18, 10);
//            List<String> answerList = JsonUtils.getZhAnswerList(this, 18, 10);
//            view_glwx.setData(question, answerList.get(0));
//        } else {
//            String question = JsonUtils.getENQuestion(this, 18, 10);
//            List<String> answerList = JsonUtils.getENAnswerList(this, 18, 10);
//            view_glwx.setData(question, answerList.get(0));
//        }
//        llcontent.removeAllViews();
...
//    }
    ...
    private void addView_JSJL() {
        view_jsjl = new View_JSJL_11(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 10);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 10);
            if("1".equals(make_sure)){
            ...
            String question = JsonUtils.getENQuestion(this, 24, 10);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 10);
            if("1".equals(make_sure)){
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4),answer);
            } else{
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
            ...
            case R.id.issue_require_ll_next:
                ...
                if ("3".equals(id)) {
                    ...
                    if (!view_fwwx.getIsEmpty()) {
                        ToastUtil.shortToast(IssueRequireKActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
...
//                    questionList.add(question);
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("10".equals(id) || "11".equals(id)) {
                        ...
                        ActivityTools.goNextActivity(this, IssueRequireLActivity.class, bundle);
                    }
                }
                break;
    ...
    private void chosePhoto() {
        ...
        Log.e("resutl=======",REQUESTCODE+"Ka");
    }

    private void ShowPopupWindow(int a, int b) {
        View view = View
                .inflate(IssueRequireKActivity.this, R.layout.item_popupwindows, null);
        view.startAnimation(AnimationUtils.loadAnimation(IssueRequireKActivity.this,
                R.anim.alpha_fade_in));
        ll_popup = (LinearLayout) view
                .findViewById(R.id.ll_popup);
        ll_popup.startAnimation(AnimationUtils.loadAnimation(IssueRequireKActivity.this,
...
//                }
            ...
            if (REQUESTCODEB == REQUESTCODE_D) {
                Uri uri = data.getData();
                path1 = FileUtils.getPath(IssueRequireKActivity.this, uri);
                try {
                    scView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path1), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path2 = FileUtils.getPath(IssueRequireKActivity.this, uri);
                try {
                    zmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path2), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path3 = FileUtils.getPath(IssueRequireKActivity.this, uri);
                try {
                    fmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path3), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
