...
import com.haiwai.housekeeper.view.View_JJYC_4;
 ...
 */
public class IssueRequireDActivity extends BaseActivity {
    ...
    private View_FWBJ_4 view_fwbj;
    private View_DTQX_4 view_dtqx;
    private View_DTQX_11 view_cpxj;
    private View_DTQX_5 view_gyqx;
    private View_FWBJ_2 view_bybj;
    private View_DTQX_2 view_abxt;
    private View_DTQX_5 view_chxd;

    private View_WXJG_3 view_wxjg;
    private View_GYQX_2 view_fwwx;
    private View_FWBJ_1 view_yywx;
    private View_WXJG_3 view_jdxd;
    private View_DTQX_5 view_gjfx;
    private View_DTQX_2 view_snfs;
    private View_DTQX_4 view_swfs;
    private View_DTQX_7 view_hsxd;
    private View_FWBJ_1 view_dgxd;
    private View_DTQX_5 view_glwx;

    private View_JJYC_4 view_jjyc;
    private View_FWBJ_8 view_ptdb;
    private View_FWBJ_8 view_bxxd;
    private View_FWBJ_8 view_ymzx;
    private View_FWBJ_8 view_swfw;
    private View_DTQX_3 view_jsjl;
    private View_FWBJ_9 view_fygz;
    private View_FWBJ_8 view_flzx;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireDActivity.this, ProDetailActivity.class, bundle);
                } else if ("isHome".equals(IMKitService.lagMap.get("isGo"))) {
                    if(Integer.valueOf(id)>=19){
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireDActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireDActivity.this, O2ODetailActivity.class, bundle);
                    }
//
//                    Bundle bundle = new Bundle();
//                    bundle.putString("id", IMKitService.lagMap.get("id"));
//                    ActivityTools.goNextActivity(IssueRequireDActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "1":
                addView_FWBJ();
                seekBar.setProgress(100 * 4 / 10);
                tvprogress.setText(100 * 4 / 10 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 10)), 5, 0, 0);
                break;
            case "2":
                addView_CPXJ();
                seekBar.setProgress(100 * 4 / 13);
                tvprogress.setText(100 * 4 / 13 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 13)), 5, 0, 0);
                break;
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 4 / 16);
                tvprogress.setText(100 * 4 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 16)), 5, 0, 0);
                break;
            case "4"://高压清洗
                addView_GYQX();
                seekBar.setProgress(100 * 4 / 10);
            ...
            case "5"://垃圾处理
                addView_LJCL();
                seekBar.setProgress(100 * 4 / 7);
                tvprogress.setText(100 * 4 / 7 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 7)), 5, 0, 0);
                break;
            case "6"://搬运搬家
                addView_BYBJ();
                seekBar.setProgress(100 * 4 / 13);
            ...
            case "7"://安保系统
                addView_ABXT();
                seekBar.setProgress(100 * 4 / 11);
                tvprogress.setText(100 * 4 / 11 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 11)), 5, 0, 0);
                break;
            case "8"://除害下单
                addView_CHXD();
                seekBar.setProgress(100 * 4 / 8);
                tvprogress.setText(100 * 4 / 8 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 8)), 5, 0, 0);
                break;
            case "9"://维修技工
                addView_WXJG();
                seekBar.setProgress(100 * 4 / 10);
            ...
            case "10"://房屋维修
                addView_FWWX();
                seekBar.setProgress(100 * 4 / 12);
                tvprogress.setText(100 * 4 / 12 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 12)), 5, 0, 0);
                break;
            case "11"://园艺维修
                addView_YYWX();
                seekBar.setProgress(100 * 4 / 12);
            ...
            case "14"://室内粉刷
                addView_SNFS();
                seekBar.setProgress(100 * 4 / 14);
                tvprogress.setText(100 * 4 / 14 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 14)), 5, 0, 0);
                break;
            case "15"://室外粉刷
                addView_SWFS();
                seekBar.setProgress(100 * 4 / 13);
            ...
            case "19"://接机用车
                addView_JJYC();
                seekBar.setProgress(100 * 4 / 9);
                tvprogress.setText(100 * 4 / 9 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 9)), 5, 0, 0);
                break;
            case "20"://陪同代办
                addView_PTDB();
                seekBar.setProgress(100 * 4 / 6);
                tvprogress.setText(100 * 4 / 6 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 6)), 5, 0, 0);
                break;
            case "21"://保险下单
                addView_BXXD();
                seekBar.setProgress(100 * 4 / 6);
            ...
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 4 / 15);
                tvprogress.setText(100 * 4 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 15)), 5, 0, 0);
                break;
            case "25"://翻译公证
                addView_FYGZ();
                seekBar.setProgress(100 * 4 / 5);
                tvprogress.setText(100 * 4 / 5 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 4 / 5)), 5, 0, 0);
                break;
            case "26"://法律咨询
                addView_FLZX();
                seekBar.setProgress(100 * 4 / 6);
    ...
    private void addView_FWBJ() {
        view_fwbj = new View_FWBJ_4(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 1, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 1, 3);
            if ("1".equals(make_sure)) {
                view_fwbj.setData3(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4),answerList.get(5), answer);
            } else {
                view_fwbj.setData3(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4),answerList.get(5));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 1, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 1, 3);
            if ("1".equals(make_sure)) {
                view_fwbj.setData3(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4),answerList.get(5), answer);
            } else {
                view_fwbj.setData3(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4),answerList.get(5));
    ...
    private void addView_DTQX() {
        view_dtqx = new View_DTQX_4(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 3, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 3, 3);
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 3, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 3, 3);
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
    ...
    private void addView_CPXJ() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 2, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 2, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 2, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 2, 3);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_GYQX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 4, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 4, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 4, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 4, 3);
            if ("1".equals(make_sure)) {
                view_gyqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answer);
            } else {
    ...
    private void addView_LJCL() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            question = JsonUtils.getZhQuestion(this, 4, 6);
            answerList = JsonUtils.getZhAnswerList(this, 4, 6);
        } else {
            question = JsonUtils.getENQuestion(this, 4, 6);
            answerList = JsonUtils.getENAnswerList(this, 4, 6);
        }
    ...
    private void addView_BYBJ() {
        view_bybj = new View_FWBJ_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 6, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 6, 3);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_bybj.setData(question, answerList.get(0), answerList.get(1));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 6, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 6, 3);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_bybj.setData(question, answerList.get(0), answerList.get(1));
    ...
    private void addView_ABXT() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 7, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 7, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 7, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 7, 3);
            if ("1".equals(make_sure)) {
                view_abxt.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5),
                        answerList.get(6), answer);
            } else {
    ...
    private void addView_CHXD() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 8, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 8, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 8, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 8, 3);
            if ("1".equals(make_sure)) {
                view_chxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answer);
            } else {
...
//            if ("1".equals(make_sure)) {
//                view_wxjg.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5),
...
//        llcontent.addView(view_wxjg);
    ...
    private void addView_FWWX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 10, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 10, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 10, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 10, 3);
            if ("1".equals(make_sure)) {
                view_fwwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5), answer);
            } else {
                view_fwwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5));
    ...
    private void addView_YYWX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 11, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 11, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 11, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 11, 3);
            if ("1".equals(make_sure)) {
                view_yywx.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_yywx.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
    ...
    private void addView_JDXD() {
        view_jdxd = new View_WXJG_3(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 12, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 12, 3);
            if ("1".equals(make_sure)) {
                view_jdxd.setData(question, answerList.get(0), answer);
            } else {
                view_jdxd.setData(question, answerList.get(0));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 12, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 12, 3);
            if ("1".equals(make_sure)) {
                view_jdxd.setData(question, answerList.get(0), answer);
            } else {
                view_jdxd.setData(question, answerList.get(0));
    ...
    private void addView_GJFX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 13, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 13, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 13, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 13, 3);
            if ("1".equals(make_sure)) {
                view_gjfx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answer);
            } else {
    ...
    private void addView_SNFS() {
        view_snfs = new View_DTQX_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 14, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 14, 3);
            if ("1".equals(make_sure)) {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3),
            ...
            String question = JsonUtils.getENQuestion(this, 14, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 14, 3);
            if ("1".equals(make_sure)) {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3),
                        answerList.get(4), answerList.get(5), answerList.get(6), answer);
            } else {
    ...
    private void addView_SWFS() {
        view_swfs = new View_DTQX_4(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 15, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 15, 3);
            if ("1".equals(make_sure)) {
                view_swfs.setData4(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3),answer);
            }else{
                view_swfs.setData3(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 15, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 15, 3);
            if ("1".equals(make_sure)) {
                view_swfs.setData4(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3),answer);
    ...
    private void addView_HSXD() {
        view_hsxd = new View_DTQX_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 16, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 16, 3);
            if ("1".equals(make_sure)) {
                view_hsxd.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_hsxd.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 16, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 16, 3);
            if ("1".equals(make_sure)) {
                view_hsxd.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_hsxd.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_DGXD() {
        view_dgxd = new View_FWBJ_1(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 17, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 17, 3);
            if ("1".equals(make_sure)) {
                view_dgxd.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2),
            ...
            String question = JsonUtils.getENQuestion(this, 17, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 17, 3);
            if ("1".equals(make_sure)) {
                view_dgxd.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answer);
            } else {
    ...
    private void addView_GLWX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 18, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 18, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 18, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 18, 3);
            if ("1".equals(make_sure)) {
                view_glwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answer);
            } else {
                view_glwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
    ...
    private void addView_JJYC() {// TODO: 2016/12/8 jump map
        view_jjyc = new View_JJYC_4(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 19, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 19, 3);
            if ("1".equals(make_sure)) {
                view_jjyc.setData1(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_jjyc.setData1(question, answerList.get(0), answerList.get(1));
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 19, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 19, 3);
            if ("1".equals(make_sure)) {
                view_jjyc.setData1(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_jjyc.setData1(question, answerList.get(0), answerList.get(1));
    ...
    private void addView_PTDB() {
        view_ptdb = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 20, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 20, 3);
            if ("1".equals(make_sure)) {
                view_ptdb.setData(question, answerList, answer);
            } else {
                view_ptdb.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 20, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 20, 3);
            if ("1".equals(make_sure)) {
                view_ptdb.setData(question, answerList, answer);
            } else {
                view_ptdb.setData(question, answerList);
    ...
    private void addView_BXXD() {
        view_bxxd = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 21, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 21, 3);
            if ("1".equals(make_sure)) {
                view_bxxd.setData(question, answerList, answer);
            } else {
                view_bxxd.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 21, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 21, 3);
            if ("1".equals(make_sure)) {
                view_bxxd.setData(question, answerList, answer);
            } else {
                view_bxxd.setData(question, answerList);
    ...
    private void addView_YMZX() {
        view_ymzx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 22, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 22, 3);
            if ("1".equals(make_sure)) {
                view_ymzx.setData(question, answerList, answer);
            } else {
                view_ymzx.setData(question, answerList);
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 22, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 22, 3);
            if ("1".equals(make_sure)) {
                view_ymzx.setData(question, answerList, answer);
            } else {
                view_ymzx.setData(question, answerList);
    ...
    private void addView_SWFW() {
        view_swfw = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 23, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 23, 3);
            if ("1".equals(make_sure)) {
                view_swfw.setData(question, answerList, answer);
            } else {
                view_swfw.setData(question, answerList);
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 23, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 23, 3);
            if ("1".equals(make_sure)) {
                view_swfw.setData(question, answerList, answer);
            } else {
                view_swfw.setData(question, answerList);
    ...
    private void addView_JSJL() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 24, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 3);
            if ("1".equals(make_sure)) {
                view_jsjl.setData4(question, answerList.get(0), answerList.get(1), answerList.get(2), "", answer);
            } else {
                view_jsjl.setData4(question, answerList.get(0), answerList.get(1), answerList.get(2), "");
    ...
    private void addView_FYGZ() {
        view_fygz = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 25, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 25, 3);
            if ("1".equals(make_sure)) {
                view_fygz.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_fygz.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 25, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 25, 3);
            if ("1".equals(make_sure)) {
                view_fygz.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_fygz.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_FLZX() {
        view_flzx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 26, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 26, 3);
            if ("1".equals(make_sure)) {
                view_flzx.setData(question, answerList, answer);
            } else {
                view_flzx.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 26, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 26, 3);
            if ("1".equals(make_sure)) {
                view_flzx.setData(question, answerList, answer);
            } else {
                view_flzx.setData(question, answerList);
    ...
    private void addView_FCMM() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 27, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 27, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 27, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 27, 3);
            if ("1".equals(make_sure)) {
                view_fcmm.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answerList.get(5), answer);
            } else {
    ...
    private void addView_LYDL() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 28, 3);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 28, 3);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 28, 3);
            List<String> answerList = JsonUtils.getENAnswerList(this, 28, 3);
            if ("1".equals(make_sure)) {
                view_lydl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answer);
            } else {
    ...
    protected void initData() {
        ...
        LogUtil.e("D-getdata", questionList + "");
    }
        ...
        switch (v.getId()) {
            case R.id.issue_require_ll_next:
                ...
                if ("1".equals(id)) {
                    ...
                    if(view_fwbj.getAnswer6().equals("")){
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_complete));
                        return ;
                    }else{
                        question.setAnswer(view_fwbj.getAnswer6());
                    }
                    questionList.add(question);
                } else if ("2".equals(id)) {
                    if (!view_cpxj.isEmpty()) {
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    }
                    ...
                    if (1 == view_dtqx.getIsEmptyState(0)) {
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    } else if (2 == view_dtqx.getIsEmptyState(0)) {
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
...
//                    questionList.add(question);
                    ...
                    if (1 == view_swfs.getIsEmptyState(0)) {
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    } else if (2 == view_swfs.getIsEmptyState(0)) {
                        ToastUtil.shortToast(IssueRequireDActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                    ...
                    question.setAnswer(view_hsxd.getAnswer2());
                    questionList.add(question);
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("25".equals(id)) {
                        ...
                        bundle.putString("at_uid", at_uid);
                        bundle.putString("make_sure", "0");
                        ActivityTools.goNextActivity(this, IssueRequireEActivity.class, bundle);
                    }
                }
                break;
    ...
    private void chosePhoto() {
        ...
        Log.e("resutl=======",REQUESTCODEB+"Da");
    }

    private void ShowPopupWindow(int a, int b) {
        View view = View
                .inflate(IssueRequireDActivity.this, R.layout.item_popupwindows, null);
        view.startAnimation(AnimationUtils.loadAnimation(IssueRequireDActivity.this,
                R.anim.alpha_fade_in));
        ll_popup = (LinearLayout) view
                .findViewById(R.id.ll_popup);
        ll_popup.startAnimation(AnimationUtils.loadAnimation(IssueRequireDActivity.this,
...
//                }
            ...
            if (REQUESTCODEB == REQUESTCODE_D) {
                Uri uri = data.getData();
                path1 = FileUtils.getPath(IssueRequireDActivity.this, uri);
                try {
                    scView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path1), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path2 = FileUtils.getPath(IssueRequireDActivity.this, uri);
                try {
                    zmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path2), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path3 = FileUtils.getPath(IssueRequireDActivity.this, uri);
                try {
                    fmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path3), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
