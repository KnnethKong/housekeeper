...
public class O2ODetailActivity extends BaseActivity implements XListView.IXListViewListener, PopGvAdapter.OnItemsClickListener {
    ...
    private void initLocationData() {
        LocationUtils locationUtils = new LocationUtils(O2ODetailActivity.this);
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        headView = getLayoutInflater().inflate(R.layout.o2o_head_view, null);
        //顶部布局
        ...
        list = new ArrayList<>();
        o2oDetailAdapter = new O2oDetailAdapter(this, list);
...
//                            llLine.setVisibility(View.VISIBLE);
                } else if (scrolledY >= 0 && scrolledY < llHeight - EvmUtil.dip2px(O2ODetailActivity.this, 25)) {
                    rltitle0.setVisibility(View.VISIBLE);
                    rltitle.setVisibility(View.GONE);
//                            llLine.setVisibility(View.VISIBLE);
                    tvbottom.setText(getString(R.string.look_for_your_sercice));
                } else if (scrolledY >= llHeight - EvmUtil.dip2px(O2ODetailActivity.this, 25)) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(O2ODetailActivity.this,ProDetailActivity.class);
    ...
    public void requestProList(final int isSwipe) {
        ...
        map.put("secret_key", SPUtils.getString(O2ODetailActivity.this, "secret", ""));
        map.put("login_key", AppGlobal.getInstance().getLoginKey() == null ? "" : AppGlobal.getInstance().getLoginKey());
        mRequestQueue.add(new PlatRequest(O2ODetailActivity.this, Contants.pro_lst, map, null, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (code == 200) {
                        ...
                        ToastUtil.shortToast(O2ODetailActivity.this, ErrorCodeUtils.getRegisterError(code + ""));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                } finally {
    ...
    private void initData(boolean b) {
        ...
        if (b) {
            ...
            ImageLoader.getInstance().displayImage(null, o2o_title_pic_iv, OptionUtils.getOptions(O2ODetailActivity.this, picList.get(Integer.valueOf(type) - 1)));
            IMKitService.lagMap.put("id", type);
    ...
    protected void click(View v) {
        switch (v.getId()) {
            ...
            case R.id.user_order_detail_ll_bottom:
                if (mApp.isLogin()) {
                    Intent intent = new Intent(O2ODetailActivity.this,CommonProActivity2.class);
    ...
    public void initZhType() {
        String json = AssetsUtils.getJson(O2ODetailActivity.this);
        try {
