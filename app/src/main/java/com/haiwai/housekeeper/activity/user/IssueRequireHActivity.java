...
import com.haiwai.housekeeper.view.View_BYBJ_7;
 ...
 */
public class IssueRequireHActivity extends BaseActivity {
    ...
    private View_FWBJ_8 view_fwbj;
    private View_DTQX_3 view_dtqx;
    private View_CPXJ_8 view_cpxj;
    private View_FWBJ_8 view_gyqx;
    private View_BYBJ_7 view_bybj;

    private View_FWBJ_8 view_wxjg;
    private View_FWBJ_1 view_fwwx;
    private View_DTQX_7 view_yywx;
    private View_FWBJ_8 view_gjfx;
    private View_DTQX_11 view_snfs;
    private View_DTQX_11 view_swfs;
    private View_FWBJ_8 view_dgxd;

    private View_FWBJ_9 view_jjyc;
    private View_FWBJ_4 view_jsjl;
    private View_FWBJ_8 view_fcmm;
    private View_FWBJ_8 view_lydl;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireHActivity.this, ProDetailActivity.class, bundle);
                } else if ("isHome".equals(IMKitService.lagMap.get("isGo"))) {

                    if(Integer.valueOf(id)>=19){
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireHActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireHActivity.this, O2ODetailActivity.class, bundle);
                    }
//                    Bundle bundle = new Bundle();
//                    bundle.putString("id", IMKitService.lagMap.get("id"));
//                    ActivityTools.goNextActivity(IssueRequireHActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "1"://可选
                addView_FWBJ();
                seekBar.setProgress(100 * 8 / 10);
                tvprogress.setText(100 * 8 / 10 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 10)), 5, 0, 0);
                break;
            case "2":
                addView_CPXJ();
                seekBar.setProgress(100 * 8 / 13);
                tvprogress.setText(100 * 8 / 13 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 13)), 5, 0, 0);
                break;
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 8 / 16);
                tvprogress.setText(100 * 8 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 16)), 5, 0, 0);
                break;
            case "4"://高压清洗
                addView_GYQX();
                seekBar.setProgress(100 * 8 / 10);
            ...
            case "7"://安保系统
                addView_ABXT();
                seekBar.setProgress(100 * 8 / 11);
                tvprogress.setText(100 * 8 / 11 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 11)), 5, 0, 0);
                break;
            case "9"://维修技工
                addView_WXJG();
                seekBar.setProgress(100 * 8 / 10);
            ...
            case "10"://房屋维修
                addView_FWWX();
                seekBar.setProgress(100 * 8 / 12);
                tvprogress.setText(100 * 8 / 12 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 12)), 5, 0, 0);
                break;
            case "11"://园艺维修
                addView_YYWX();
                seekBar.setProgress(100 * 8 / 12);
            ...
            case "14"://室内粉刷
                addView_SNFS();
                seekBar.setProgress(100 * 8 / 14);
                tvprogress.setText(100 * 8 / 14 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 14)), 5, 0, 0);
                break;
            case "15"://室外粉刷
                addView_SWFS();
                seekBar.setProgress(100 * 8 / 13);
            ...
            case "19"://接机用车
                addView_JJYC();
                seekBar.setProgress(100 * 8 / 9);
                tvprogress.setText(100 * 8 / 9 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 9)), 5, 0, 0);
                break;
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 8 / 15);
                tvprogress.setText(100 * 8 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 8 / 15)), 5, 0, 0);
                break;
            case "27"://房产买卖
                addView_FCMM();
                seekBar.setProgress(100 * 8 / 10);
    ...
    private void addView_FWBJ() {
        view_fwbj = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 1, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 1, 7);
            if ("1".equals(make_sure)) {
                view_fwbj.setData(question, answerList, answer);
            } else {
                view_fwbj.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 1, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 1, 7);
            if ("1".equals(make_sure)) {
                view_fwbj.setData(question, answerList, answer);
            } else {
                view_fwbj.setData(question, answerList);
    ...
    private void addView_DTQX() {
        view_dtqx = new View_DTQX_3(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 3, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 3, 7);
            if ("1".equals(make_sure)) {
                view_dtqx.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), "", answer);
            } else {
                view_dtqx.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), "");
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 3, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 3, 7);
            if ("1".equals(make_sure)) {
                view_dtqx.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), "", answer);
            } else {
                view_dtqx.setData2(question, answerList.get(0), answerList.get(1), answerList.get(2), "");
    ...
    private void addView_CPXJ() {
        view_cpxj = new View_CPXJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 2, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 2, 7);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),answerList.get(3),answerList.get(4), answer);
            } else {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),answerList.get(3),answerList.get(4));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 2, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 2, 7);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3),answerList.get(4), answer);
            } else {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),answerList.get(3),answerList.get(4));
    ...
    private void addView_GYQX() {
        view_gyqx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 4, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 4, 7);
            if ("1".equals(make_sure)) {
                view_gyqx.setData(question, answerList, answer);
            } else {
                view_gyqx.setData(question, answerList);
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 4, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 4, 7);
            if ("1".equals(make_sure)) {
                view_gyqx.setData(question, answerList, answer);
            } else {
                view_gyqx.setData(question, answerList);
    ...
    private void addView_BYBJ() {
        view_bybj = new View_BYBJ_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 6, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 6, 7);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 6, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 6, 7);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_ABXT() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 7, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 7, 7);
            tvtitle.setText(question);
            rb1.setText(answerList.get(0));
            rb2.setText(answerList.get(1));
        } else {
            String question = JsonUtils.getENQuestion(this, 7, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 7, 7);
            tvtitle.setText(question);
            rb1.setText(answerList.get(0));
            rb2.setText(answerList.get(1));
        }
    ...
    private void addView_WXJG() {
        view_wxjg = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 9, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 9, 7);
            if ("1".equals(make_sure)) {
                view_wxjg.setData(question, answerList, answer);
            } else {
                view_wxjg.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 9, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 9, 7);
            if ("1".equals(make_sure)) {
                view_wxjg.setData(question, answerList, answer);
            } else {
                view_wxjg.setData(question, answerList);
    ...
    private void addView_FWWX() {
        view_fwwx = new View_FWBJ_1(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 10, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 10, 7);
            if ("1".equals(make_sure)) {
                view_fwwx.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2),
            ...
            String question = JsonUtils.getENQuestion(this, 10, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 10, 7);
            if ("1".equals(make_sure)) {
                view_fwwx.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answer);
            } else {
    ...
    private void addView_YYWX() {
        view_yywx = new View_DTQX_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 11, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 11, 7);
            if ("1".equals(make_sure)) {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 11, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 11, 7);
            if ("1".equals(make_sure)) {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_GJFX() {
        view_gjfx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 13, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 13, 7);
            if ("1".equals(make_sure)) {
                view_gjfx.setData(question, answerList, answer);
            } else {
                view_gjfx.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 13, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 13, 7);
            if ("1".equals(make_sure)) {
                view_gjfx.setData(question, answerList, answer);
            } else {
                view_gjfx.setData(question, answerList);
    ...
    private void addView_SNFS() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 14, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 14, 7);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 14, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 14, 7);
            if ("1".equals(make_sure)) {
                view_snfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_snfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_SWFS() {
        view_swfs = new View_DTQX_11(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 15, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 15, 7);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 15, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 15, 7);
            if ("1".equals(make_sure)) {
                view_swfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_swfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_DGXD() {
        view_dgxd = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 17, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 17, 7);
            if ("1".equals(make_sure)) {
                view_dgxd.setData(question, answerList, answer);
            } else {
                view_dgxd.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 17, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 17, 7);
            if ("1".equals(make_sure)) {
                view_dgxd.setData(question, answerList, answer);
            } else {
                view_dgxd.setData(question, answerList);
    ...
    private void addView_JJYC() {
        view_jjyc = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 19, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 19, 7);
            if ("1".equals(make_sure)) {
                view_jjyc.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_jjyc.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 19, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 19, 7);
            if ("1".equals(make_sure)) {
                view_jjyc.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_jjyc.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_JSJL() {
        view_jsjl = new View_FWBJ_4(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 7);
            if ("1".equals(make_sure)) {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answer);
            } else {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 24, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 7);
            if ("1".equals(make_sure)) {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answer);
            } else {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
    ...
    private void addView_FCMM() {
        view_fcmm = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 27, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 27, 7);
            if ("1".equals(make_sure)) {
                view_fcmm.setData(question, answerList, answer);
            } else {
                view_fcmm.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 27, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 27, 7);
            if ("1".equals(make_sure)) {
                view_fcmm.setData(question, answerList, answer);
            } else {
                view_fcmm.setData(question, answerList);
    ...
    private void addView_LYDL() {
        view_lydl = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 28, 7);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 27, 7);
            if ("1".equals(make_sure)) {
                view_lydl.setData(question, answerList, answer);
            } else {
                view_lydl.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 28, 7);
            List<String> answerList = JsonUtils.getENAnswerList(this, 27, 7);
            if ("1".equals(make_sure)) {
                view_lydl.setData(question, answerList, answer);
            } else {
    ...
    protected void initData() {
        ...
        LogUtil.e("H-getdata", questionList + "");
    }
            ...
            case R.id.issue_require_ll_next:
                ...
                if ("1".equals(id)) {
                    ...
                    if (1 == view_cpxj.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireHActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    }
                    ...
                    if (1 == view_dtqx.getIsEmptyState()) {
                        ...
                        ToastUtil.shortToast(IssueRequireHActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("19".equals(id)) {
                        ...
                        ActivityTools.goNextActivity(this, IssueRequireIActivity.class, bundle);
                    }
                }
                break;
    ...
    private void chosePhoto() {
        ...
        Log.e("resutl=======",REQUESTCODE+"Ha");
    }

    private void ShowPopupWindow(int a, int b) {
        View view = View
                .inflate(IssueRequireHActivity.this, R.layout.item_popupwindows, null);
        view.startAnimation(AnimationUtils.loadAnimation(IssueRequireHActivity.this,
                R.anim.alpha_fade_in));
        ll_popup = (LinearLayout) view
                .findViewById(R.id.ll_popup);
        ll_popup.startAnimation(AnimationUtils.loadAnimation(IssueRequireHActivity.this,
...
//                }
            ...
            if (REQUESTCODEB == REQUESTCODE_D) {
                Uri uri = data.getData();
                path1 = FileUtils.getPath(IssueRequireHActivity.this, uri);
                try {
                    scView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path1), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path2 = FileUtils.getPath(IssueRequireHActivity.this, uri);
                try {
                    zmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path2), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path3 = FileUtils.getPath(IssueRequireHActivity.this, uri);
                try {
                    fmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path3), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
