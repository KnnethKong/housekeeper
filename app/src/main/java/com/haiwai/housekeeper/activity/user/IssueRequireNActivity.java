 ...
 */
public class IssueRequireNActivity extends BaseActivity {
    ...
    private View_FWBJ_8 view_dtqx;
    private View_FWBJ_9 view_jsjl;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireNActivity.this, ProDetailActivity.class, bundle);
                } else if ("isHome".equals(IMKitService.lagMap.get("isGo"))) {

                    if(Integer.valueOf(id)>=19){
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireNActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireNActivity.this, O2ODetailActivity.class, bundle);
                    }
...
//                    ActivityTools.goNextActivity(IssueRequireNActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 14 / 16);
                tvprogress.setText(100 * 14 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 14 / 16)), 5, 0, 0);
                break;
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 14 / 15);
                tvprogress.setText(100 * 14 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 14 / 15)), 5, 0, 0);
                break;
        }
    }

    private void addView_DTQX() {
        view_dtqx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            ...
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList, answer);
            } else {
                view_dtqx.setData(question, answerList);
            }
        } else {
    ...
    private void addView_JSJL() {
        view_jsjl = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 13);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 13);
            if ("1".equals(make_sure)) {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 24, 13);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 13);
            if ("1".equals(make_sure)) {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            ...
            case R.id.issue_require_ll_next:
                ...
                if ("3".equals(id)) {
                    ...
                    if (view_jsjl.getIsEmpty()) {
                        ToastUtil.shortToast(IssueRequireNActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("24".equals(id)) {
                        ...
                        ActivityTools.goNextActivity(this, IssueRequireOActivity.class, bundle);
                    }
                }
                break;
