...
import com.haiwai.housekeeper.view.View_CPXJ_7;
 ...
 */
public class IssueRequireIActivity extends BaseActivity {
    ...
    private View_FWBJ_9 view_fwbj;
    private View_FWBJ_2 view_dtqx;
    private View_FWBJ_2 view_cpxj;
    private View_FWBJ_9 view_gyxj;
    private View_DTQX_11 view_bybj;
    private View_FWBJ_8 view_abxt;

    private View_FWBJ_9 view_wxjg;
    private View_FWBJ_9 view_gjfx;
    private View_FWBJ_2 view_snfs;
    private View_JDXD_2 view_swfs;
    private View_FWBJ_9 view_dgxd;
    private View_FWBJ_8 view_glwx;

    private View_JJYC_1 view_jjyc;
    private View_CPXJ_7 view_jsjl;
    private View_FWBJ_9 view_fcmm;
    private View_FWBJ_9 view_lydl;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireIActivity.this, ProDetailActivity.class, bundle);
                } else if ("isHome".equals(IMKitService.lagMap.get("isGo"))) {

                    if(Integer.valueOf(id)>=19){
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireIActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireIActivity.this, O2ODetailActivity.class, bundle);
                    }
...
//                    ActivityTools.goNextActivity(IssueRequireIActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "1"://可选
                addView_FWBJ();
                seekBar.setProgress(100 * 9 / 10);
                tvprogress.setText(100 * 9 / 10 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 10)), 5, 0, 0);
                break;
            case "2":
                addView_CPXJ();
                seekBar.setProgress(100 * 9 / 13);
                tvprogress.setText(100 * 9 / 13 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 13)), 5, 0, 0);
                break;
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 9 / 16);
                tvprogress.setText(100 * 9 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 16)), 5, 0, 0);
                break;
            case "4"://高压清洗
                addView_GYQX();
                seekBar.setProgress(100 * 9 / 10);
            ...
            case "7"://安保系统
                addView_ABXT();
                seekBar.setProgress(100 * 9 / 11);
                tvprogress.setText(100 * 9 / 11 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 11)), 5, 0, 0);
                break;
            case "9"://维修技工
                addView_WXJG();
                seekBar.setProgress(100 * 9 / 10);
            ...
            case "10"://房屋维修
                addView_FWWX();
                seekBar.setProgress(100 * 9 / 12);
                tvprogress.setText(100 * 9 / 12 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 12)), 5, 0, 0);
                break;
            case "11"://园艺维修
                addView_FWWX();
                seekBar.setProgress(100 * 9 / 12);
            ...
            case "14"://室内粉刷
                addView_SNFS();
                seekBar.setProgress(100 * 9 / 14);
                tvprogress.setText(100 * 9 / 14 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 14)), 5, 0, 0);
                break;
            case "15"://室外粉刷
                addView_SWFS();
                seekBar.setProgress(100 * 9 / 13);
...
//                break;
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 9 / 15);
                tvprogress.setText(100 * 9 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 9 / 15)), 5, 0, 0);
                break;
            case "27"://房产买卖
                addView_FCMM();
                seekBar.setProgress(100 * 9 / 10);
    ...
    private void addView_FWBJ() {
        view_fwbj = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            ...
            if ("1".equals(make_sure)) {
                view_fwbj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
    ...
    private void addView_DTQX() {
        view_dtqx = new View_FWBJ_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 3, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 3, 8);
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 3, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 3, 8);
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1));
    ...
    private void addView_CPXJ() {
        view_cpxj = new View_FWBJ_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 2, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 2, 8);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 2, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 2, 8);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1));
    ...
    private void addView_GYQX() {
        view_gyxj = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 4, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 4, 8);
            if ("1".equals(make_sure)) {
                view_gyxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_gyxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 4, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 4, 8);
            if ("1".equals(make_sure)) {
                view_gyxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_gyxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
        ...
        llcontent.removeAllViews();
        llcontent.addView(view_gyxj);
    }

    //搬运搬家
    private void addView_BYBJ() {
        view_bybj = new View_DTQX_11(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 6, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 6, 8);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 6, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 6, 8);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_ABXT() {
        view_abxt = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 7, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 7, 8);
            if ("1".equals(make_sure)) {
                view_abxt.setData(question, answerList, answer);
            } else {
                view_abxt.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 7, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 7, 8);
            if ("1".equals(make_sure)) {
                view_abxt.setData(question, answerList, answer);
            } else {
                view_abxt.setData(question, answerList);
    ...
    private void addView_WXJG() {
        view_wxjg = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 9, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 9, 8);
            if ("1".equals(make_sure)) {
                view_wxjg.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_wxjg.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 9, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 9, 8);
            if ("1".equals(make_sure)) {
                view_wxjg.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_wxjg.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_GJFX() {
        view_gjfx = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 13, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 13, 8);
            if ("1".equals(make_sure)) {
                view_gjfx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_gjfx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 13, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 13, 8);
            if ("1".equals(make_sure)) {
                view_gjfx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_gjfx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_SNFS() {
        view_snfs = new View_FWBJ_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 14, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 14, 8);
            if ("1".equals(make_sure)) {
                view_snfs.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_snfs.setData(question, answerList.get(0), answerList.get(1));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 14, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 14, 8);
            if ("1".equals(make_sure)) {
                view_snfs.setData(question, answerList.get(0), answerList.get(1), answer);
            } else {
                view_snfs.setData(question, answerList.get(0), answerList.get(1));
    ...
    private void addView_SWFS() {
        view_swfs = new View_JDXD_2(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 15, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 15, 8);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 15, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 15, 8);
            if ("1".equals(make_sure)) {
                view_swfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answerList.get(5), answerList.get(6), answerList.get(7), answer);
            } else {
    ...
    private void addView_DGXD() {
        view_dgxd = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 17, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 17, 8);
            if ("1".equals(make_sure)) {
                view_dgxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_dgxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 17, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 17, 8);
            if ("1".equals(make_sure)) {
                view_dgxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_dgxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_GLWX() {
        view_glwx = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 18, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 18, 8);
            if ("1".equals(make_sure)) {
                view_glwx.setData(question, answerList, answer);
            } else {
                view_glwx.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 18, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 18, 8);
            if ("1".equals(make_sure)) {
                view_glwx.setData(question, answerList, answer);
            } else {
                view_glwx.setData(question, answerList);
...
//        view_jjyc = new View_JJYC_1(this);
//        if ("zh".equalsIgnoreCase(isZhorEn)) {
//            String question = JsonUtils.getZhQuestion(this, 19, 8);
//            List<String> answerList = JsonUtils.getZhAnswerList(this, 19, 8);
//            view_jjyc.setData(question, answerList.get(0));
//        } else {
//            String question = JsonUtils.getENQuestion(this, 19, 8);
//            List<String> answerList = JsonUtils.getENAnswerList(this, 19, 8);
//            view_jjyc.setData(question, answerList.get(0));
//        }
//        llcontent.removeAllViews();
...
//    }
    ...
    private void addView_JSJL() {
        view_jsjl = new View_CPXJ_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 8);
            if ("1".equals(make_sure)) {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
            ...
            String question = JsonUtils.getENQuestion(this, 24, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 8);
            if ("1".equals(make_sure)) {
                view_jsjl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answerList.get(5), answerList.get(6), answer);
            } else {
    ...
    private void addView_FCMM() {
        view_fcmm = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 27, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 27, 8);
            if ("1".equals(make_sure)) {
                view_fcmm.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_fcmm.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 27, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 27, 8);
            if ("1".equals(make_sure)) {
                view_fcmm.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_fcmm.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_LYDL() {
        view_lydl = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 28, 8);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 28, 8);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 28, 8);
            List<String> answerList = JsonUtils.getENAnswerList(this, 28, 8);
            if ("1".equals(make_sure)) {
                view_lydl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_lydl.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    protected void initData() {
        ...
        LogUtil.e("I-getdata", questionList + "");
    }
            ...
            case R.id.issue_require_ll_next:
                ...
                if ("1".equals(id)) {
                    if (!view_fwbj.getIsEmpty()) {
                        ToastUtil.shortToast(IssueRequireIActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                    ...
                    if (view_gyxj.getIsEmpty()) {
                        ToastUtil.shortToast(IssueRequireIActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                    question.setQuestion(view_gyxj.getQuestion());
                    question.setAnswer(view_gyxj.getAnswer());
                    questionList.add(question);
                } else if ("6".equals(id)) {
                    ...
                    if (0 != view_swfs.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireIActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    }
...
//                }
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("1".equals(id) || "4".equals(id) || "9".equals(id) || "13".equals(id) || "17".equals(id)) {
                        Bundle bundle = new Bundle();
                        ...
                        if ("27".equals(id) || "28".equals(id)) {
                            ...
                            ActivityTools.goNextActivity(this, IssueRequireJActivity.class, bundle);
                        }
                    }
                }
                break;
    ...
    private void ShowPopupWindow(int a, int b) {
        View view = View
                .inflate(IssueRequireIActivity.this, R.layout.item_popupwindows, null);
        view.startAnimation(AnimationUtils.loadAnimation(IssueRequireIActivity.this,
                R.anim.alpha_fade_in));
        ll_popup = (LinearLayout) view
                .findViewById(R.id.ll_popup);
        ll_popup.startAnimation(AnimationUtils.loadAnimation(IssueRequireIActivity.this,
...
//                }
            ...
            if (REQUESTCODEB == REQUESTCODE_D) {
                Uri uri = data.getData();
                path1 = FileUtils.getPath(IssueRequireIActivity.this, uri);
                try {
                    scView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path1), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path2 = FileUtils.getPath(IssueRequireIActivity.this, uri);
                try {
                    zmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path2), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path3 = FileUtils.getPath(IssueRequireIActivity.this, uri);
                try {
                    fmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path3), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
        ...
        switch (requestCode) {
            ...
            case 222:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // 没有获取到权限，做特殊处理
                    Toast.makeText(this, "获取相机权限失败，请手动开启", Toast.LENGTH_SHORT).show();
                }
                break;
            case 223:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                  ...
                  chosePhoto();
                    ...
                    // 没有获取到权限，做特殊处理
                    Toast.makeText(this, "获取相册权限失败，请手动开启", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
