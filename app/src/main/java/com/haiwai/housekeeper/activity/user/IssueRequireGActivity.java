...
import com.haiwai.housekeeper.view.View_FCMM7;
import com.haiwai.housekeeper.view.View_FLZX_3;
import com.haiwai.housekeeper.view.View_FLZX_3_1;
 ...
 */
public class IssueRequireGActivity extends BaseActivity {
    ...
    private View_FWBJ_7 view_fwbj;
    private View_DTQX_7 view_dtqx;
    private View_CPXJ_7 view_cpxj;
    private View_BYBJ_7 view_bybj;
    private View_DTQX_5 view_abxt;
    private View_FWBJ_9 view_chxd;

    private View_DTQX_5 view_fwwx;
    private View_ABXT_1 view_yywx;
    private View_FWBJ_9 view_jdxd;
    private View_FWBJ_1 view_snfs;
    private View_JDXD_2 view_swfs;
    private View_FWBJ_9 view_hsxd;
    private View_DTQX_5 view_glwx;

    private View_FWBJ_8 view_jjyc;
    private View_FWBJ_1 view_jsjl;
    private View_FCMM7 view_fcmm;
    private View_FLZX_3_1 view_lydl;
        ...
        getRightView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("isFind".equals(IMKitService.lagMap.get("isGo"))) {
                    ...
                    ActivityTools.goNextActivity(IssueRequireGActivity.this, ProDetailActivity.class, bundle);
                } else if ("isHome".equals(IMKitService.lagMap.get("isGo"))) {

                    if(Integer.valueOf(id)>=19){
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireGActivity.this, O2ODetailActivity2.class, bundle);
                    }else{
                        Bundle bundle = new Bundle();
                        bundle.putString("id", IMKitService.lagMap.get("id"));
                        ActivityTools.goNextActivity(IssueRequireGActivity.this, O2ODetailActivity.class, bundle);
                    }
...
//                    ActivityTools.goNextActivity(IssueRequireGActivity.this, O2ODetailActivity.class, bundle);
    ...
    private void initQuestion() {
        ...
        switch (id) {
            case "1"://可选
                addView_FWBJ();
                seekBar.setProgress(100 * 7 / 10);
                tvprogress.setText(100 * 7 / 10 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 10)), 5, 0, 0);
                break;
            case "2":
                addView_CPXJ();
                seekBar.setProgress(100 * 7 / 13);
                tvprogress.setText(100 * 7 / 13 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 13)), 5, 0, 0);
                break;
            case "3"://地毯清洗
                addView_DTQX();
                seekBar.setProgress(100 * 7 / 16);
                tvprogress.setText(100 * 7 / 16 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 16)), 5, 0, 0);
                break;
            case "4"://高压清洗
                addView_GYQX();
                seekBar.setProgress(100 * 7 / 10);
            ...
            case "7"://安保系统
                addView_ABXT();
                seekBar.setProgress(100 * 7 / 11);
                tvprogress.setText(100 * 7 / 11 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 11)), 5, 0, 0);
                break;
            case "8"://除害下单
                addView_CHXD();
                seekBar.setProgress(100 * 7 / 8);
                tvprogress.setText(100 * 7 / 8 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 8)), 5, 0, 0);
                break;
            case "9"://维修技工
                addView_GYQX();
                seekBar.setProgress(100 * 7 / 10);
            ...
            case "10"://房屋维修
                addView_FWWX();
                seekBar.setProgress(100 * 7 / 12);
                tvprogress.setText(100 * 7 / 12 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 12)), 5, 0, 0);
                break;
            case "11"://园艺维修
                addView_YYWX();
                seekBar.setProgress(100 * 7 / 12);
            ...
            case "14"://室内粉刷
                addView_SNFS();
                seekBar.setProgress(100 * 7 / 14);
                tvprogress.setText(100 * 7 / 14 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 14)), 5, 0, 0);
                break;
            case "15"://室外粉刷
                addView_SWFS();
                seekBar.setProgress(100 * 7 / 13);
            ...
            case "19"://接机用车
                addView_JJYC();
                seekBar.setProgress(100 * 7 / 9);
                tvprogress.setText(100 * 7 / 9 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 9)), 5, 0, 0);
                break;
            case "24"://驾驶教练
                addView_JSJL();
                seekBar.setProgress(100 * 7 / 15);
                tvprogress.setText(100 * 7 / 15 + "%");
                tvprogress.setPadding(((int) (Float.valueOf(seekbarwidth) * 7 / 15)), 5, 0, 0);
                break;
            case "27"://房产买卖
                addView_FCMM();
                seekBar.setProgress(100 * 7 / 10);
    ...
    private void addView_FWBJ() {
        view_fwbj = new View_FWBJ_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 1, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 1, 6);
            if ("1".equals(make_sure)) {
                view_fwbj.setData(question, answerList.get(0), answerList.get(1),
                        answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5), answer);
            } else {
                view_fwbj.setData(question, answerList.get(0), answerList.get(1),
                        answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5));
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 1, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 1, 6);
            if ("1".equals(make_sure)) {
                view_fwbj.setData(question, answerList.get(0), answerList.get(1),
                        answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5), answer);
            } else {
    ...
    private void addView_DTQX() {
        view_dtqx = new View_DTQX_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 3, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 3, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 3, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 3, 6);
            if ("1".equals(make_sure)) {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_dtqx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_CPXJ() {
        view_cpxj = new View_CPXJ_7(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 2, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 2, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 2, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 2, 6);
            if ("1".equals(make_sure)) {
                view_cpxj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answerList.get(5), answerList.get(6), answer);
            } else {
    ...
    private void addView_GLWX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 18, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 18, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 18, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 18, 6);
            if ("1".equals(make_sure)) {
                view_glwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answer);
            } else {
                view_glwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
    ...
    private void addView_BYBJ() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 6, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 6, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 6, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 6, 6);
            if ("1".equals(make_sure)) {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_bybj.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_ABXT() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 7, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 7, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 7, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 7, 6);
            if ("1".equals(make_sure)) {
                view_abxt.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answer);
            } else {
                view_abxt.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4));
    ...
    private void addView_CHXD() {
        view_chxd = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 8, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 8, 6);
            if ("1".equals(make_sure)) {
                view_chxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_chxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 8, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 8, 6);
            if ("1".equals(make_sure)) {
                view_chxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_chxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_FWWX() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 10, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 10, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 10, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 10, 6);
            if ("1".equals(make_sure)) {
                view_fwwx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answer);
            } else {
    ...
    private void addView_YYWX() {
        view_yywx = new View_ABXT_1(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 11, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 11, 6);
            if ("1".equals(make_sure)) {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5),
            ...
            String question = JsonUtils.getENQuestion(this, 11, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 11, 6);
            if ("1".equals(make_sure)) {
                view_yywx.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answerList.get(4), answerList.get(5),
                        answerList.get(6), answerList.get(7), answerList.get(8), answer);
            } else {
    ...
    private void addView_JDXD() {
        view_jdxd = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 12, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 12, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 12, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 12, 6);
            if ("1".equals(make_sure)) {
                view_jdxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_jdxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_SNFS() {
        view_snfs = new View_FWBJ_1(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 14, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 14, 6);
            if ("1".equals(make_sure)) {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 14, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 14, 6);
            if ("1".equals(make_sure)) {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_snfs.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
    ...
    private void addView_SWFS() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 15, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 15, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 15, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 15, 6);
            if ("1".equals(make_sure)) {
                view_swfs.setData(question, answerList.get(0), answerList.get(1), answerList.get(2),
                        answerList.get(3), answerList.get(4), answerList.get(5), answerList.get(6), answerList.get(7),answer);
            } else {
    ...
    private void addView_HSXD() {
        view_hsxd = new View_FWBJ_9(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 16, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 16, 6);
            if ("1".equals(make_sure)) {
                view_hsxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_hsxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
            }

        } else {
            String question = JsonUtils.getENQuestion(this, 16, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 16, 6);
            if ("1".equals(make_sure)) {
                view_hsxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2), answer);
            } else {
                view_hsxd.setData(question, answerList.get(0), answerList.get(1), answerList.get(2));
    ...
    private void addView_JJYC() {
        view_jjyc = new View_FWBJ_8(this);
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 19, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 19, 6);
            if ("1".equals(make_sure)) {
                view_jjyc.setData(question, answerList, answer);
            } else {
                view_jjyc.setData(question, answerList);
            }
        } else {
            String question = JsonUtils.getENQuestion(this, 19, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 19, 6);
            if ("1".equals(make_sure)) {
                view_jjyc.setData(question, answerList, answer);
            } else {
                view_jjyc.setData(question, answerList);
    ...
    private void addView_JSJL() {
        ...
        if ("zh".equalsIgnoreCase(isZhorEn)) {
            String question = JsonUtils.getZhQuestion(this, 24, 6);
            List<String> answerList = JsonUtils.getZhAnswerList(this, 24, 6);
            if ("1".equals(make_sure)) {
            ...
            String question = JsonUtils.getENQuestion(this, 24, 6);
            List<String> answerList = JsonUtils.getENAnswerList(this, 24, 6);
            if ("1".equals(make_sure)) {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3), answer);
            } else {
                view_jsjl.setData1(question, answerList.get(0), answerList.get(1), answerList.get(2), answerList.get(3));
    ...
    private void addView_FCMM() {
        view_fcmm = new View_FCMM7(this);
        if("1".equals(make_sure)){
            view_fcmm.setData(answer);
        }
        llcontent.removeAllViews();
    ...
    private void addView_LYDL() {
        view_lydl = new View_FLZX_3_1(this);
        if("1".equals(make_sure)){
            view_lydl.setData(answer);
        }
        llcontent.removeAllViews();
    ...
    protected void initData() {
        ...
        LogUtil.e("G-getdata", questionList + "");
    }
            ...
            case R.id.issue_require_ll_next:
                ...
                if ("1".equals(id)) {
                    ...
                    if (1 == view_cpxj.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireGActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    }
                    ...
                    if (!view_dtqx.getIsEmpty()) {
                        ToastUtil.shortToast(IssueRequireGActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                    ...
                    if (1 == view_swfs.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireGActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    } else if (2 == view_swfs.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireGActivity.this, getString(R.string.issue_require_complete));
                        return;
                    }
                    ...
                    if (1 == view_lydl.getIsEmptyState()) {
                        ToastUtil.shortToast(IssueRequireGActivity.this, getString(R.string.issue_require_at_least_one));
                        return;
                    }
                ...
                if ("1".equals(make_sure)) {
                    ...
                    if ("8".equals(id) || "12".equals(id) || "16".equals(id)) {
                        Bundle bundle = new Bundle();
                        ...
                        ActivityTools.goNextActivity(this, IssueRequireHActivity.class, bundle);
                    }
                }
                break;
    ...
    private void chosePhoto() {
        ...
        Log.e("resutl=======",REQUESTCODE+"Ga");
    }

    private void ShowPopupWindow(int a, int b) {
        View view = View
                .inflate(IssueRequireGActivity.this, R.layout.item_popupwindows, null);
        view.startAnimation(AnimationUtils.loadAnimation(IssueRequireGActivity.this,
                R.anim.alpha_fade_in));
        ll_popup = (LinearLayout) view
                .findViewById(R.id.ll_popup);
        ll_popup.startAnimation(AnimationUtils.loadAnimation(IssueRequireGActivity.this,
...
//                }
            ...
            if (REQUESTCODEB == REQUESTCODE_D) {
                Uri uri = data.getData();
                path1 = FileUtils.getPath(IssueRequireGActivity.this, uri);
                try {
                    scView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path1), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path2 = FileUtils.getPath(IssueRequireGActivity.this, uri);
                try {
                    zmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path2), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                Uri uri = data.getData();
                path3 = FileUtils.getPath(IssueRequireGActivity.this, uri);
                try {
                    fmView.setImageBitmap(BimpUtils.extractMiniThumb(BimpUtils.revitionImageSize(path3), 140, 140));
                } catch (IOException e) {
                    e.printStackTrace();
