...
public class O2oDetailAdapter extends BaseAdapter {
    ...
    private O2ODetailActivity context;
...
//    private Map<Integer,ImageView> map2 = new HashMap<>();
    ...
    public O2oDetailAdapter(O2ODetailActivity context, List<ProListEntity.DataBean> list) {
...
//        proGradeView.setNum(300);
        ...
        if (Integer.valueOf(list.get(position).getPro_onum()) == 0) {
            ...
            vh.setTextview(R.id.item_o2o_detail_tv_danping, context.getString(R.string.o2o_detail_has_done) + list.get(position).getPro_onum() + context.getString(R.string.o2o_detail_dan_pingjia) + String.format("%.1f", Float.valueOf(list.get(position).getPro_xing()) / Integer.valueOf(list.get(position).getPro_onum())));// TODO: 2016/10/20 评价
        }
