 ...
 */
public class HomeHouseMaintenanceAdapter extends RecyclerView.Adapter<HomeHouseMaintenanceAdapter.MyViewHolder> {
    ...
    public HomeHouseMaintenanceAdapter(Context context, List<HomeEntity.DataBean.FanwBean> list, List<Integer> picLists) {
