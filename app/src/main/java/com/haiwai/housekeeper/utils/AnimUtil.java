...
public class AnimUtil {
	...
	public static void closeMenu(RelativeLayout rl,int startOffset){
		...
		//pivotXValue: 0-1
//		RotateAnimation animation = new RotateAnimation(0, -180,//左到右
		RotateAnimation animation = new RotateAnimation(0, 180,//右到左
	...
	public static void showMenu(RelativeLayout rl,int startOffset){
		...
		TranslateAnimation animation = new TranslateAnimation(180,180,180,0);
		animation.setDuration(500);
